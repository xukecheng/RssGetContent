...
COPY . .
EXPOSE 8889
RUN pip3 install --no-cache-dir cos-python-sdk-v5 jinja2 aioredis requests beautifulsoup4  fastapi uvicorn[standard] lxml -i https://mirrors.cloud.tencent.com/pypi/simple
